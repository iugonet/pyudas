...
def gps_cosmic_fsi_nc(
    trange=['2009-06-01', '2009-06-02'],
    site='cosmic',
    datatype='all',
    parameter='',
    no_update=False,
    ...
    #===== Set parameters (1) =====#
    file_format = 'netcdf'
    remote_data_dir = 'http://database.rish.kyoto-u.ac.jp/arch/iugonet/data/GPS/cosmic/fsi/v2_0/nc/'
    local_path = '/rish/cosmic/fsi/v2_0/'
    prefix = 'gps_ro_cosmic_fsi_'
    file_res = 3600. * 24
    site_list = ['cosmic']
    datatype_list = ['']
    parameter_list = ['']
        ...
        for dt in dt_list:
            ...
            for pr in pr_list:
                ...
                if (not downloadonly) and (not notplot):
                    ...
                    options(current_tplot_name, 'ytitle', 'Height')
                    options(current_tplot_name, 'ysubtitle', '[km]')
