...
def ltr_rish(
    ...
    sgk_start=datetime.datetime.strptime('1999-07-07','%Y-%m-%d')
    sgk_end=datetime.datetime.strptime('2006-03-29','%Y-%m-%d')
    ...
    header_only = False
    data_start = 2
    site_list = ['sgk'] # all sites(default)
        ...
        for dt in dt_list:
            if len(dt) < 1:
                ...
                for pr in pr_list:
                    ...
                    local_path = 'rish/misc/' + st + '/ltr/csv'
                    ...
                    if (len(loaded_data_temp) > 0) and ror:
                        try:
                            ...
                            print('************************************************************************** \n' \
                        + 'If you acquire LTR data, we ask that you acknowledge us in your use \n' \
                        + 'of the data. This may be done by including text such as LTR data \n' \
                        + 'provided by Research Institute for Sustainable Humanosphere of \n' \
                        + 'Kyoto University. We would also appreciate receiving a copy of the \n' \
                        + 'relevant publications. The distribution of LTR data has been partly \n' \
                    ...
                    if (not downloadonly) and (not notplot):
                        ...
                        options(varname_st_dt_pr,'ytitle', 'LTR-'+st+'\nHeight [km]')
