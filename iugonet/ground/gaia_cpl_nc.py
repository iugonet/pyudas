...
def gaia_cpl_nc(
    ...
    #===== Set parameters (1) =====#
    file_format = 'netcdf'
    remote_data_dir = 'https://aer-nc-web.nict.go.jp/gaia/wk3/gaia/'
    local_path = '/gaia/wk3/gaia/'
    prefix = 'gaia_cpl_'
    file_res = 3600. * 24
    site_list = ['']
    datatype_list = ['']
    parameter_list = ['xoi', 'xo2i', 'xn2i', 'xnoi',\
                       'ginao', 'ginmo', 'ginmn', 'ginuu',\
                          'ginvv', 'ginww', 'te', 'ti', 'gintmp',\
                              'efr', 'eft', 'efp', 'cur', 'cut', 'cup']
    time_netcdf='time'
    #==============================#
    ...
    for st in st_list:
        ...
        for dt in dt_list:
            ...
            for pr in pr_list:
                ...
                #===== Set parameters (2) =====#
                pathformat = pr+'_cpl/%Y/'+pr+'%Y%m%dcpl.nc'
                #==============================#
                ...
                loaded_data_temp = load(trange=trange, site=st, datatype=dt, parameter=pr, \
                    ...
                    get_support_data=get_support_data, varformat=varformat, specvarname='',varnames=varnames, \
                ...
                if (not downloadonly) and (not notplot):
                    ...
                    # current_tplot_name = prefix+'time__'+pr
