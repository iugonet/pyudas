...
def gps_champ_fsi_nc(
    ...
    #===== Set parameters (1) =====#
    file_format = 'netcdf'
    remote_data_dir = 'http://database.rish.kyoto-u.ac.jp/arch/iugonet/data/GPS/champ/fsi/v1_0/nc/'
    local_path = '/rish/champ/fsi/v1_0/'
    prefix = 'gps_ro_champ_fsi_'
    file_res = 3600. * 24
    site_list = ['champ']
    datatype_list = ['']
    parameter_list = ['']
